    ...
    <div class="bg-base-1 d-flex align-items-center flex-fill">
        <div class="container h-100 py-6">
            ...
            <div class="text-center d-block d-lg-none">
                <h2 class="mb-3 d-inline-block">{{ __('Contact') }}</h2>
                <div class="m-auto">
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm overflow-hidden">
                        <div class="row no-gutters">
                            ...
                            <div class="col-12 col-lg-7 bg-dark d-none d-lg-flex flex-fill background-size-cover" style="background-image: url({{ asset('images/contact.svg') }})">
