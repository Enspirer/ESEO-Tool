    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('admin.settings', 'license') }}">
            ...
            <div class="form-group">
                ...
                <input id="i-license-key" type="text" class="form-control{{ $errors->has('license_key') ? ' is-invalid' : '' }}" name="license_key" placeholder="Random value" value="{{ old('license_key') }}" autofocus>
