                                                    ...
                                                    <div class="d-none" id="bank-instructions">
                                                            ...
                                                            <div class="form-group mb-2">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="input-group-append">
                                                                        <div class="btn btn-sm btn-primary" data-enable="tooltip-copy" title="{{ __('Copy') }}" data-copy="{{ __('Copy') }}" data-copied="{{ __('Copied') }}" data-clipboard-target="#i-bank-account-owner">{{ __('Copy') }}</div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        @if(config('settings.bank_account_number'))
                                                            <div class="form-group mb-2">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="input-group-append">
                                                                        <div class="btn btn-sm btn-primary" data-enable="tooltip-copy" title="{{ __('Copy') }}" data-copy="{{ __('Copy') }}" data-copied="{{ __('Copied') }}" data-clipboard-target="#i-bank-account-number">{{ __('Copy') }}</div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        @if(config('settings.bank_name'))
                                                            <div class="form-group mb-2">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="input-group-append">
                                                                        <div class="btn btn-sm btn-primary" data-enable="tooltip-copy" title="{{ __('Copy') }}" data-copy="{{ __('Copy') }}" data-copied="{{ __('Copied') }}" data-clipboard-target="#i-bank-name">{{ __('Copy') }}</div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        @if(config('settings.bank_routing_number'))
                                                            <div class="form-group mb-2">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="input-group-append">
                                                                        <div class="btn btn-sm btn-primary" data-enable="tooltip-copy" title="{{ __('Copy') }}" data-copy="{{ __('Copy') }}" data-copied="{{ __('Copied') }}" data-clipboard-target="#i-bank-routing-number">{{ __('Copy') }}</div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        @if(config('settings.bank_iban'))
                                                            <div class="form-group mb-2">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="input-group-append">
                                                                        <div class="btn btn-sm btn-primary" data-enable="tooltip-copy" title="{{ __('Copy') }}" data-copy="{{ __('Copy') }}" data-copied="{{ __('Copied') }}" data-clipboard-target="#i-bank-iban">{{ __('Copy') }}</div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        @if(config('settings.bank_bic_swift'))
                                                            <div class="form-group mb-2">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="input-group-append">
                                                                        <div class="btn btn-sm btn-primary" data-enable="tooltip-copy" title="{{ __('Copy') }}" data-copy="{{ __('Copy') }}" data-copied="{{ __('Copied') }}" data-clipboard-target="#i-bank-bic-swift">{{ __('Copy') }}</div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="form-group mb-2">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-append">
                                                                    <div class="btn btn-sm btn-primary" data-enable="tooltip-copy" title="{{ __('Copy') }}" data-copy="{{ __('Copy') }}" data-copied="{{ __('Copied') }}" data-clipboard-target="#i-payment-id">{{ __('Copy') }}</div>
                                                                </div>
                                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="country" id="i-country" class="custom-select{{ $errors->has('country') ? ' is-invalid' : '' }}">
                                        ...
                                        @foreach(config('countries') as $key => $value)
                                            <option value="{{ $key }}" @if ((old('country') !== null && $key == old('country')) || (isset($user->billing_information->country) && $key == $user->billing_information->country) && old('country') == null) selected @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
